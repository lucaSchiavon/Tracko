...
var App = function () {
    ...
    var lockPortlet = function ($portlet) {
        var el = $portlet.children(".portlet-body");
        App.blockUI({ target: el });
    }
    var unlockPortlet = function ($portlet) {
        var el = $portlet.children(".portlet-body");
        App.unblockUI(el);
    }
    ...
    var modalMessageSuccess = function(title, text) {
        //var hasC = $('body').hasClass('modal-open');
    ...
    var modalMessageError = function(title, text) {
        //var hasC = $('body').hasClass('modal-open');
    ...
    var setCheckAllTable = function () {
        $('.js-check-all').click(function () {
            var elem = $(this);
            elem.closest('table').find('tr:visible input[type="checkbox"]').bootstrapSwitch('state', true);
        });
    }

    var logOffUser = function (success) {
        var oData = {};        
        $.ajax({
            type: 'POST'
            , dataType: 'json'
    ...
    return {
        ...
        init: function () {
            ...
            handleDatePickers(); //handle datepicker
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><img src="/Content/images/loading-spinner-grey.gif" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '')+'"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {    
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img src="/Content/images/loading-spinner-grey.gif" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        , messageSuccess: modalMessageSuccess
        ...
        , reApplyTooltip: handleTooltips

        , lockPortlet: lockPortlet
        , unlockPortlet: unlockPortlet
