@ModelType Model.Sorgenti.IndexMaskModel
@Code
    ViewData("Title") = "Elenco Sorgenti"
        ...
        <div class="portlet">
            ...
            <div class="portlet-body">
                ...
                <div class="margin-top-10">
                    <table id="tableElencoSorgenti" class="table table-striped table-bordered table-hover"></table>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        var SorgentiController = function () {
            ...
            var buildTable = function () {
                ...
                tElenco = $('#tableElencoSorgenti').DataTable({
                    ...
                    , bLengthChange: false
                    , ajax: {
                        "url": '/api/sorgenti/GetList'
                        , "type": "POST"
                        , "data": oData
                    }
                    , columns: [{ "title": "Nome", "data": "Nome" }
                                , { "title": "SystemName", "data": "SystemName" }
                                , { "title": "SettingMask", "data": "SettingMask" }
                                //, { "title": "Cliente", "data": "Cliente" }
                                , { "title": "GuidKey", "data": "GuidKey" }
                                , {
                                    "title": ""
                                    , "orderable": false
                                    , "searchable": false
            ...
            var bindEvents = function () {
                ...
                tElenco.on('click', 'a.js-delete-sorgente', function (e) {
                    ...
                    BootstrapDialog.confirm({
                        ...
                        title: 'Attenzione',
                        message: 'Eliminare il sorgente selezionato?',
                        closable: true,
                        btnCancelLabel: 'No',
                        btnOKLabel: 'Elimina',
                        callback: function (result) {
                            if (result) {
                                deleteSorgenteData(anchor.data("id"), deleteSorgenteDataSuccess);
                            }
                        }
                    });
                });
            ...
            //Delete
            var deleteSorgenteData = function (uId, success) {
                $.ajax({
                    type: 'POST'
                    , dataType: 'json'
                    , contentType: 'application/json'
                    , url: '/sorgente/delete/' + uId
                    , success: success
                });
            }
            var deleteSorgenteDataSuccess = function (response) {
