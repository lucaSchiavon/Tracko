    ...
    <div class="col-md-12">
        <div class="portlet">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-list"></i> Elenco Clienti
                </div>
            </div>
            <div class="portlet-body">
                <div class="row form-inline">
                    <div class="col-md-6 form-group">
                        <label>Nome</label>
                        <input id="FiltroNomeCliente" type="text" class="form-control" />
                ...
                <div class="margin-top-10">
                    <table id="tableElencoClienti" class="table table-striped table-bordered table-hover"></table>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        var ClientiController = function () {
            ...
            var filterNome = function (settings, dataIndex) {
                var filtroNome = $('#FiltroNomeCliente').val();
            ...
            var buildTable = function () {
                tElenco = $('#tableElencoClienti').DataTable({
                    dom: templateNoSearch,
                    searching: true
                    , info: true
                    , fnInfoCallback: function (oSettings, iStart, iEnd, iMax, iTotal, sPre) {
                        return "Numero Clienti: " + iTotal;
                    }
                    , bLengthChange: false
                    , ajax: {
                        "url": '/api/clienti/GetList'
                        , "type": "POST"
                    }
                    , columns: [{ "title": "Nome", "data": "Nome" }
                                , { "title": "APIKey", "data": "APIKey" }
                                , { "title": "GuidKey", "data": "GuidKey" }
                                , { "title": "N. Sorgenti", "data": "Sorgenti" }
                                , { "title": "", "width": "25", "data": "IsDeleted" }
                                , {
                                    "title": ""
                                    , "orderable": false
                                    , "searchable": false
