...
Public Class AccountController
    ...
    '
    ' POST: /Account/Login
    'ValidateAntiForgeryToken evita che un altro form posti i dati da un'altra applicazione, in questo
    'modo potrebbe iniettare contenuti malevoli, così viene gestito l'invio con un token (campo nascosto) e salvato
    'anche in cookies (_RequestVerificationToken) il token hidden field e il cookies vengono confrontati a fronte di un post
    'del form e se non corrispondono i dati inviati vengono rigettati
    <HttpPost>
    <AllowAnonymous>
